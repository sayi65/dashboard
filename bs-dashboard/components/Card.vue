    ...
    max-width="700">
        ...
        <v-card-title 
            ...
            <v-layout 
                ...
                <v-flex xs5 md4 lg3 xl2 sm4 align-center style="padding">
                    <v-chip
                        v-if="item.status === 0"
                        color="green">
                        問題なし
        ...
        <v-card-text class="white">
            ...
            <v-flex xs6 class="text-xs-right" v-if="item.isNew == true">
                <v-icon color="red accent-3" large>fiber_new</v-icon>
            </v-flex>
            </v-layout>
        </v-card-text>
